...
const Cart = () => {
  const { cart } = useSelector((state) => state); // for accessing state from cartSlice
  ...
  return (
    <div>
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            <div className="flex flex-col p-5 gap-5 my-14  h-[100%]">
              ...
              <div className="flex flex-col gap-5 ">
                ...
                <p className="text-xl">
                  <span className="text-gray-700 font-semibold -mt-2 text-xl">
            ...
            <div className="flex flex-col">
              ...
              <button className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-2 text-lg mb-32">
                CheckOut Now
              </button>
            </div>
          </div>
      ...
      <p className="text-center mb-4 text-lg font-semibold">
        © Copyright | <span className="text-slate-700">Made by</span> ❤️‍🔥 with
        Chinmay Kaitade.
      </p>
    </div>
  );
